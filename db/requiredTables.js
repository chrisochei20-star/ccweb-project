...
const REQUIRED_TABLES = [
  ...
  "ccweb_wallets",
  "ccweb_earnings",
  "ccweb_internal_wallets",
  "ccweb_flutterwave_transactions",
  "ccweb_course_purchases",
  "ccweb_payout_requests",
  "ccweb_admin_audit_logs",
  "ccweb_trust_reports",
  "ccweb_moderation_actions",
  "ccweb_push_device_tokens",
  "ccweb_marketplace_stores",
  "ccweb_marketplace_listings",
