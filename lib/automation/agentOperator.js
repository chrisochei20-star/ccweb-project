...
const PROBLEM_PATTERNS = [
  {
    ...
    primaryAgents: ["marketing-automation", "market-research", "workflow-orchestrator"],
  },
  {
  ...
  },
  {
    ...
    primaryAgents: ["marketing-automation", "market-research", "finance-analyst"],
  },
  {
    ...
    primaryAgents: ["finance-analyst", "market-research", "workflow-orchestrator"],
  },
];
...
function matchProblemPattern(text) {
  ...
  return {
    ...
    templateId: "tpl-sales-pipeline",
    primaryAgents: ["workflow-orchestrator", "market-research", "ops-runner"],
  };
}
