...
module.exports.PIPELINE_TEMPLATES = [
  {
    ...
    stages: [
      ...
      { id: "s2", label: "Audience & offer analysis", kind: "ai_analysis", agentHint: "research-analyst" },
  ...
  },
  {
    ...
    stages: [
      ...
      { id: "s2", label: "ICP fit scoring", kind: "ai_analysis", agentHint: "research-analyst" },
  ...
  },
  {
    ...
    stages: [
      ...
      { id: "s2", label: "Source & synthesize", kind: "ai_analysis", agentHint: "research-analyst" },
      ...
      { id: "s5", label: "Weekly refinement", kind: "feedback", agentHint: "research-analyst" },
    ],
  },
];
