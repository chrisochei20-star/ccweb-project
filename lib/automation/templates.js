...
module.exports.PIPELINE_TEMPLATES = [
  ...
  {
    id: "tpl-lead-generation",
    name: "Lead generation engine",
    description: "Research ICPs, discover contacts, personalize outreach, schedule follow-ups, track funnel metrics.",
    domain: "marketing",
    stages: [
      { id: "s1", label: "Campaign inputs", kind: "trigger", agentHint: "workflow-orchestrator" },
      { id: "s2", label: "AI market research", kind: "ai_analysis", agentHint: "market-research" },
      { id: "s3", label: "Lead discovery & enrichment", kind: "execution", agentHint: "marketing-automation" },
      { id: "s4", label: "Personalized outreach", kind: "execution", agentHint: "marketing-automation" },
      { id: "s5", label: "Follow-up & tracking", kind: "feedback", agentHint: "workflow-orchestrator" },
    ],
  },
];
